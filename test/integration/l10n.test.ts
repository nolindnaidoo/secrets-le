 ...
 */
describe('Secrets-LE localization', function () {
	this.timeout(30_000);

	const extension = vscode.extensions.getExtension('nolindnaidoo.secrets-le');
	...
	it('substitutes positional placeholders at runtime', () => {
		...
		const one = vscode.l10n.t('Sanitization failed: {0}', 7);
