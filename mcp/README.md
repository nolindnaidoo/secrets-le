...
[VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=nolindnaidoo.secrets-le)
...
[extension README](https://github.com/nolindnaidoo/secrets-le#readme).
...
| **[secrets-le](https://github.com/nolindnaidoo/secrets-le/tree/main/crate)** | This server's own binary: find hardcoded credentials, and never print one | [crates.io](https://crates.io/crates/secrets-le) |
